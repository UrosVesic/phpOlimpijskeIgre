    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <li class="active"><a href="index.php"> Odjavi se</a>
          <li>
        </ul>
      </div>
    </div>
            ...
            <table id="myTable">
              ...
              <tbody>
                ...
                while ($red = $rezultat->fetch_array()) : ?>
                  ...
                  <tr>
                    <td colspan='5'>
                      <button onclick="sortiraj(3)">Sortiraj tabelu po zemljama</button>
                      <button onclick="sortiraj(2)">Sortiraj tabelu po sportovima</button>
                    </td>
                  </tr>
              </tbody>
            </table>
